...
CREATE TABLE IF NOT EXISTS `EzHRM`.`THAMSO` (
  ...
  `ThoiGianDiTreToiDa` TINYINT NOT NULL,
  `ThoiGianVeSomToiDa` TINYINT NOT NULL,
  `SoNgayDuocPhepDiTre` TINYINT NOT NULL,
  `TruLuongDiTreTheoPhanTram` TINYINT NOT NULL,
  `TruLuongDiTreTrucTiep` TINYINT NOT NULL,
