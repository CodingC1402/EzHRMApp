...
CREATE TABLE IF NOT EXISTS `EzHRM`.`THAMSO` (
  ...
  `TruLuongDiTreTheoPhanTram` FLOAT NOT NULL,
  `TruLuongDiTreTrucTiep` DECIMAL NOT NULL,
  `TruLuongVangMatTheoPhanTram` FLOAT NOT NULL,
  `TruLuongVangMatTrucTiep` DECIMAL NOT NULL,
  `NgayTinhLuongHangThang` DATE NOT NULL,
