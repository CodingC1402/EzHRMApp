...
CREATE TABLE IF NOT EXISTS `EzHRM`.`DONVICONGVIEC` (
  ...
  `SoSanPhamTrongiGio` INT NOT NULL DEFAULT 0,
  `SoSanPhamNgoaiGio` INT NOT NULL,
  `SoHopDongThoaThuanTrongGio` INT NOT NULL DEFAULT 0,
  `SoHopDongThoaThuanNgoaiGio` INT NOT NULL,
